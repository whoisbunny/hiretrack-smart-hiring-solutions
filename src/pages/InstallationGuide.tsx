        ...
        <div className="prose prose-slate dark:prose-invert max-w-none">
          ...
          <section className="mb-12 scroll-mt-24">
            ...
            <ul className="list-disc list-inside space-y-3 text-muted-foreground mt-4">
              ...
              <li><strong>Root or Sudo Access:</strong> Initial root or sudo access to the server</li>
          ...
          <section className="mb-12 scroll-mt-24">
            ...
            <p className="text-muted-foreground mb-6">Choose your installation approach. <strong className="text-primary">User-based is more secure and recommended</strong>; Root-based is faster but less isolated.</p>
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-6">
              ...
              <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
                ...
                <Button asChild className="w-full">
                  <Link to="/user-based-installation">
                    Start User-Based Installation
                  </Link>
                </Button>
              </div>
              ...
              <div className="bg-muted/50 border border-border rounded-lg p-6">
                ...
                <Button asChild variant="outline" className="w-full">
                  <Link to="/root-based-installation">
                    Start Root-Based Installation
                  </Link>
                </Button>
              </div>
            </div>
